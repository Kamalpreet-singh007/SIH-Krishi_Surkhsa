  ...
  return (
    <AppLayout>
      <div className="max-w-7xl mx-auto p-4 sm:p-6">
        <div className="mb-8">
          <h1 className="text-2xl font-bold mb-2">Welcome, {user?.name || "Farmer"}!</h1>
          <p className="text-default-500">
            Get personalized crop recommendations and agricultural advice based on your location and conditions.
          </p>
        </div>
              ...
              <CardBody className="gap-4">
                ...
                <div className="space-y-4">
                  {recommendedCrops.map((crop) => (
                    <div key={crop.id} className="flex items-center p-3 rounded-medium bg-default-50">
                      <div className="bg-primary-100 p-2 rounded-full mr-4">
                        <Icon icon={crop.icon} className="text-primary h-5 w-5" />
                      </div>
            ...
            <Card className="h-full">
              <CardBody className="gap-4">
                <div className="flex justify-between items-center">
                  ...
                  <Icon icon="lucide:landmark" className="text-primary h-6 w-6" />
                </div>
